	    ...
	    <div class="panel-heading"> 
	      <div class="panel-title"  flag="show" id="searchTitle">
	        <a data-toggle="collapse" data-parent="#accordion" href="#searchDiv" onclick="change()">
	        	学生搜索<i class="fa fa-plus-square"></i></a>
	      </div>
	      <script>
	           function  change(){
	      ...
	      <div class="panel-body">
			  <form id="queryAssetForm" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<label class="col-sm-4 control-label no-padding-right" for="name">年龄</label>
						<div class="col-sm-8">
							<input type="text" name="age" id="age" class="form-control">
						</div>
					</div>
					<div class="col-md-3">
						<label class="col-sm-4 control-label no-padding-right" for="shortName">电话号码 </label>
						<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-md-6 text-right">
						<button type="button" class="btn btn-md" onclick="queryStuent()">
