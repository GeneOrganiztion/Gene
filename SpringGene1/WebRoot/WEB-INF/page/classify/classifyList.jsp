...
<div class="page-content">
	...
	<div id="actions-before" class="btn-group">	
        <button type="button" onclick="addOneClassify()" class="btn-link"><i class="glyphicon glyphicon-plus"></i> &nbsp;添加一级分类</button>
        <button type="button" onclick="addTwoClassify()" class="btn-link"><i class="glyphicon glyphicon-plus"></i> &nbsp;添加二级分类</button>
        <button type="button" onclick="editOneClassify()" class="btn-link"><i class="glyphicon glyphicon-edit"></i> &nbsp;修改一级分类</button>
        <button type="button" onclick="deleteOneClassify()" class="btn-link"><i class="glyphicon glyphicon-remove"></i> &nbsp;删除一级分类</button>
    </div>
	<div class="row">
		<div class="col-xs-12">
